...
abstract class AbstractAdminFlowInputProcessor(
    ...
    private fun processWhoIsInterestedCommand(): StepOutput =
        StepOutput.PlainText(
            message = messageSource[FlowStep.ADMIN_WHO_IS_INTERESTED_ASK_APARTMENT_ID],
            nextStep = FlowStep.ADMIN_WHO_IS_INTERESTED_ASK_APARTMENT_ID
        )
    ...
    private fun processApartmentInfoCommand(): StepOutput =
        StepOutput.PlainText(
            message = messageSource[FlowStep.ADMIN_APARTMENT_INFO_ASK_APARTMENT_ID],
            nextStep = FlowStep.ADMIN_APARTMENT_INFO_ASK_APARTMENT_ID
        )
