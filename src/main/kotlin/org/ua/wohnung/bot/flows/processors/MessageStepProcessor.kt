...
//
//    class RegisteredUserConversationStart(private val userService: UserService) : MessageStepProcessor() {
...
//    }
//
//    object Empty : MessageStepProcessor() {
//        override fun invoke(chatMetadata: ChatMetadata, input: String): List<Message> {
//            return listOf(Message(input))
//        }
//
