...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record4<Integer, Integer, String, Role> {
    ...
    @Override
    public Row4<Integer, Integer, String, Role> valuesRow() {
    ...
    @Override
    public AccountRecord values(Integer value1, Integer value2, String value3, Role value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Integer id, Integer chatId, String username, Role role) {
        super(Account.ACCOUNT);
