...
public class Apartment extends TableImpl<ApartmentRecord> {
    ...
    /**
     * The column <code>main.apartment.etage</code>.
     */
    public final TableField<ApartmentRecord, String> ETAGE = createField(DSL.name("etage"), SQLDataType.VARCHAR(1024), this, "");
    ...
    /**
     * The column <code>main.apartment.wbs</code>.
     */
    public final TableField<ApartmentRecord, Boolean> WBS = createField(DSL.name("wbs"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>main.apartment.wbs_details</code>.
     */
