...
public class ApartmentAccountRecord extends UpdatableRecordImpl<ApartmentAccountRecord> implements Record3<Integer, String, OffsetDateTime> {
    ...
    @Override
    public ApartmentAccountRecord values(Integer value1, String value2, OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public ApartmentAccountRecord(Integer accountId, String apartmentId, OffsetDateTime applyTs) {
        super(ApartmentAccount.APARTMENT_ACCOUNT);
