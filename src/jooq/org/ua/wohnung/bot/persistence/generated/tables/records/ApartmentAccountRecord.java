...
public class ApartmentAccountRecord extends UpdatableRecordImpl<ApartmentAccountRecord> implements Record4<Long, String, OffsetDateTime, Boolean> {
    ...
    public Field<Boolean> field4() {
        return ApartmentAccount.APARTMENT_ACCOUNT.HIDDEN;
    }
    ...
    @Override
    public ApartmentAccountRecord value4(Boolean value) {
        setHidden(value);
        return this;
    }

    @Override
    public ApartmentAccountRecord values(Long value1, String value2, OffsetDateTime value3, Boolean value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ApartmentAccountRecord(Long accountId, String apartmentId, OffsetDateTime applyTs, Boolean hidden) {
        super(ApartmentAccount.APARTMENT_ACCOUNT);
